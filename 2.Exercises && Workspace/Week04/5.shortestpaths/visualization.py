...
binary_path = "./shortestpaths_viz" # TODO
...
use_gmaps = True # TODO
# # TODO and request an API key from here:
...
class GUI:
	...
	def __init__(self):
		...
		Tk.Label(header, text="Street Graph Viewer (controls: left click = set start, right click = set target, 'x'+left click = recenter, 'p' = zoom in, 'm' key = zoom out)").pack(side=Tk.LEFT)
		...
		self.c.bind("<Button-2>", right_mouse_down)
